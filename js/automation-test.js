var AutomationTest = (function(){
	function loginAll(resorts){
		resorts.forEach(function(resort){
			Actions.createTab("http://local." + resort + ".com/home1")
			.then(function(tab){
	...
	function login(resort){
		Actions.navigate(null, "http://local." + resort + ".com/home1")
			.then(function(tab){
				return Actions.waitUntilElement(tab, ".global-nav-input.username", 1000);
			})
			.then(function(result){
